    ...
    <div id="view-profile-hub" className="view-section fade-in">
            ...
            <div className="profile-frame">
                ...
                <div className="frame-grid">
                    ...
                    <div className="frame-item" onClick={() => { alert('فرم مشخصات سایز لباس و کفش بازیکن...') }}>
            ...
            <div className="profile-frame" style={{"padding":"10px 16px"}}>
                <div className="frame-grid" style={{"gridTemplateColumns":"1fr"}}>
                    <div className="frame-item" onClick={() => navigate('/password')} style={{"flexDirection":"row","justifyContent":"center","background":"#fff","borderStyle":"dashed","padding":"12px","gap":"8px"}}>
                        <i className="fa fa-lock" style={{"color":"var(--warning)","fontSize":"1.2rem"}}></i>
                        <span>تنظیمات امنیت و تغییر رمز عبور</span>
                    </div>
                </div>
            </div>
        </div>
